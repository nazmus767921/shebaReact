...
const Faqs = {
	...
	bn: {
		...
		faq: [
			{
				id: "1",
				question: "গর্ভকালে কি হোমিওপ্যাথী চিকিৎসা নিরাপদ?",
				answer:
					"আপনি হোমিওপ্যাথীর ওপর সম্পূর্ণ আস্থা রাখতে পারেন। সেবা হোমিও হলে প্রাকৃতিক ও সম্পূর্ণ নিরাপদ ঔষধ ব্যবহার করে চিকিৎসা করা হয়। তাই এতে অন্যান্য ঔষধাধির মত গুরুতর কোনো পার্শ্ব প্রতিক্রিয়া নেই।",
			},
			{
				id: "2",
				question: "হোমিওপ্যাথী কি বাচ্চাদের জন্য নিরাপদ?",
				answer:
					"হ্যাঁ, বাচ্চাদের জন্যও হোমিওপ্যাথী ও ন্যাচারোপ্যাথী নিরাপদ। যেমন আমরা আগেই বলেছি যে,সেবা হোমিও হলে প্রাকৃতিক ও সম্পূর্ণ নিরাপদ ঔষধ ব্যবহার করে চিকিৎসা করা হয়। তাই এতে অন্যান্য ঔষধাধির মত বাচ্চাদের জন্যও তেমন কোনো পার্শ্ব প্রতিক্রিয়া নেই।",
			},
			{
				id: "3",
				question:
					"হোমিওপ্যাথী বা ন্যাচারোপ্যাথী কি ইরেক্টাইল ডিসফাংশান ঠিক করতে পারে?",
				answer:
					"ইরেক্টাইল ডিসফাংশান সহ অন্যান্য যৌন সমস্যা গুলোর চিকিৎসাও হোমিওপ্যাথীতে আছে কোনো প্রকার পার্শ্ব প্রতিক্রিয়া ছাড়া। তাই বর্তমানে অনেকে হোমিওপ্যাথীর দিকে অগ্রসর হচ্ছে। যৌন সমস্যা নিয়ে অনেক রোগী আমাদের কাছে এসে ভালো ফল পেয়েছে। আমরা আশা করি আপনারও যদি এরুপ কোনো সমস্যা থাকে তাহলে আমদের থেকে চিকিৎসা নিয়ে ভালো ফল পাবেন ইনশাআল্লাহ্‌।",
			},
			{
				id: "4",
				question: "হোমিওপ্যাথী কি রোগের লক্ষণ বাড়ায়?",
				answer:
					"হ্যাঁ, কিছু কিছু ক্ষেত্রে বাড়ায়, আর কিছু কিছু ক্ষেত্রে লক্ষণ বেড়ে যাওয়াটা চিকিৎসারই অংশ হয়। কিন্তু এতে ভয় পাওয়ার নিছু নেই, কারণ এগুলো খুবই বিরল।",
			},
			{
				id: "5",
				question: "হোমিওপ্যাথী ধীরে কাজ করে কেন?",
				answer:
					"প্রতিটা ভালো জিনিস হওয়ার জন্য সময়ের প্রয়োজন। হোমিওপ্যাথী ও ন্যাচারোপ্যাথী আপনাকে পুরোপুরি আপনার জটিল ও দীর্ঘস্থায়ী রোগগুলো থেকে মুক্তি দেওয়ার লক্ষ্য নিয়ে কাজ করে। সুতরাং একটু সময় নেওয়াটা কি স্বাভাবিক নয়? যদি পুরোপুরি সুস্থ্ হতে চান তবে একটু  ধৈর্য্য ধরতে হবে।",
			},
		],
	},
};
