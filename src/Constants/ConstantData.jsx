	...
	bn: {
		...
		faq: [
			...
			},
			{
				...
				answer:
					"প্রতিটা ভালো জিনিস হওয়ার জন্যা সময়ের প্রয়োজন। হোমিওপ্যাথী ও ন্যাচারোপ্যাথী আপনাকে পুরোপুরি আপনার জটিল ও দীর্ঘস্থায়ী রোগগুলো থেকে মুক্তি দেওয়ার লক্ষ্য নিয়ে কাজ করে। সুতরাং একটু সময় নেওয়াটা কি সাভাবিক নয়? যদি পুরোপুরি সুস্থ্ হতে চান তবে একটু  ধৈর্য্য ধরতে হবে।",
			},
		],
	},
};
